...
test_that(
  "float number characters is correct",
  {
...
test_that(
  "exits on NA error or non-number for float",
  {
...
test_that(
  "type argument is either 'integer' or 'float'",
  {
